...
/* harmony default export */ var GridLayoutvue_type_script_lang_js_ = ({
          ...
          methods: {
            ...
            containerHeight: function containerHeight() {
              ...
              return bottom(this.layout) * (this.rowHeight + this.margin[1]) + this.margin[1] + this.offsetHeight + 'px';
            },
...
//# sourceMappingURL=vue-grid-layout.common.js.maprect = interactable && action.name ? interactable.getRect(element) : null;
  setInteractionCursor(interaction, scope);
